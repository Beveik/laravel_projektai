                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <button class="btn btn-dark postDelete"
                                            data-postid="{{ $post->id }}">DELETE</button>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data.posts_count == 0) {
                                $(".posts").remove();
                                $(".posts-list").remove();
                                $(".container-show").append(
                                    "<div class='alert alert-danger'><p>The category has no posts.</p></div> "
                                    )
                                //
                            }
                        }
