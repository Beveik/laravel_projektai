    ...
    <div class="container">
        <form method="POST" action="{{ route('post.store') }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="postTitle" type="text" class="form-control @error('postTitle') is-invalid @enderror"
                        name="postTitle">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <textarea id="clientDescription" name="postDescription"
                        class="summernote form-control @error('postDescription') is-invalid @enderror">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    <input id="postAuthor" type="text" class="form-control @error('postAuthor') is-invalid @enderror"
                        name="postAuthor">
            ...
            <div class="form-group row postCategory">
                ...
                <div class="col-md-6">
                    ...
                    <select id="postCategory" class="form-control @error('postCategory') is-invalid @enderror"
                        name="postCategory">
            ...
            <div class="category-info d-none">
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="categoryTitle" type="text"
                            class="form-control @error('categoryTitle') is-invalid @enderror" name="categoryTitle">
                ...
                <div class="form-group row">
                    <label for="categoryExcerpt"
                        class="col-md-4 col-form-label text-md-right">{{ __('Category Excerpt') }}</label>

                    <div class="col-md-6">
                        <textarea id="categoryExcerpt" name="categoryExcerpt"
                            class="summernote form-control @error('categoryExcerpt') is-invalid @enderror">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <textarea id="categoryDescription" name="categoryDescription"
                            class="summernote form-control @error('categoryDescription') is-invalid @enderror">
