    ...
    <div class="container">
        ...
        <div class="ajaxForm">
            <div class="form-group row">
                ...
                <input class="form-control col-md-4" type="text" name="title" id="title" value="test" required/>
            ...
            <div class="form-group row">
                <label for="price" class="col-md-4 col-form-label text-md-right">Client Price</label>
                <input class="form-control col-md-4" type="text" name="price" id="price" value="test" required/>
