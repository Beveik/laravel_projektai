                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('author.update', [$author]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="author_name" type="text" class="form-control @error('author_name') is-invalid @enderror " value="{{$author->name}}" name="author_name" required autofocus>
                                @error('author_name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="author_surname" type="text" class="form-control @error('author_surname') is-invalid @enderror " value="{{$author->surname}}" name="author_surname" required autofocus>
