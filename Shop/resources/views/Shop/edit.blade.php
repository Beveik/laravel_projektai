                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('shop.update', [$shop]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="shop_title" type="text" class="form-control @error('shop_title') is-invalid @enderror " value="{{$shop->title}}" name="shop_title" required autofocus>
                                @error('shop_title')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="shop_email" type="text" class="form-control @error('shop_email') is-invalid @enderror " value="{{$shop->email}}" name="shop_email" required autofocus>
                                @error('shop_email')
                                    <span role="alert" class="invalid-feedback">
                                        <strong>*{{$message}}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="shop_phone" type="text" class="form-control @error('shop_phone') is-invalid @enderror " value="{{$shop->phone}}" name="shop_phone" required autofocus>
                                @error('shop_phone')
                                    <span role="alert" class="invalid-feedback">
                                        <strong>*{{$message}}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="shop_country" type="text" class="form-control @error('shop_country') is-invalid @enderror " value="{{$shop->country}}" name="shop_country" required autofocus>
                                @error('shop_country')
                                    <span role="alert" class="invalid-feedback">
                                        <strong>*{{$message}}</strong>
                                    </span>
