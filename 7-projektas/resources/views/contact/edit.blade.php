                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('contact.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="title" type="text" class="form-control" name="contact_title" value="{{$contact->title}}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control" name="contact_phone" value="{{$contact->phone}}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text" class="form-control" name="contact_address" value="{{$contact->address}}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control" name="contact_email" value="{{$contact->email}}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="country" type="text" class="form-control" name="contact_country" value="{{$contact->country}}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="city" type="text" class="form-control" name="contact_city" value="{{$contact->city}}" required>
